...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lzt;->b:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lzt;->l:Landroid/text/TextUtils$TruncateAt;

    sget-object v0, Landroid/text/Layout$Alignment;->ALIGN_CENTER:Landroid/text/Layout$Alignment;

    iput-object v0, p0, Lzt;->m:Landroid/text/Layout$Alignment;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lzt;->n:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lzt;->o:Landroid/graphics/Rect;
...
.method private final a()Z
    ...
    iget-object v0, p0, Lzt;->h:Landroid/text/StaticLayout;
...
.method private static b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    sget-object v5, Lzt;->a:[Ljava/lang/Class;
...
.method public final a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lzt;->b:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Lzt;->c:Landroid/text/TextPaint;
    ...
    invoke-virtual {p0, v4}, Lzt;->a(Landroid/text/TextPaint;)V
    ...
    iget-object v5, p0, Lzt;->c:Landroid/text/TextPaint;
    ...
    iget-object v3, p0, Lzt;->f:Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, Lzt;->l:Landroid/text/TextUtils$TruncateAt;
    ...
    :goto_1
    iget-object v6, p0, Lzt;->f:Ljava/lang/CharSequence;
    ...
    iget-boolean v5, p0, Lzt;->p:Z

    if-eqz v5, :cond_4

    invoke-static {v3}, Lzr;->a(Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Lzt;->d:Ljava/lang/String;

    iget-object v3, p0, Lzt;->d:Ljava/lang/String;
    ...
    iget-object v3, p0, Lzt;->l:Landroid/text/TextUtils$TruncateAt;
    ...
    iget-object v3, p0, Lzt;->m:Landroid/text/Layout$Alignment;
    ...
    iput-object v0, p0, Lzt;->h:Landroid/text/StaticLayout;

    iput-boolean v2, p0, Lzt;->q:Z

    iput-boolean v1, p0, Lzt;->r:Z
    ...
    invoke-direct {p0}, Lzt;->a()Z

    move-result p2

    xor-int/lit8 v8, p2, 0x1

    iget-object p2, p0, Lzt;->b:Landroid/graphics/Rect;
    ...
    :goto_5
    iget-object v4, p0, Lzt;->b:Landroid/graphics/Rect;

    invoke-virtual {v4}, Landroid/graphics/Rect;->height()I

    move-result v4

    iget-object v5, p0, Lzt;->b:Landroid/graphics/Rect;

    invoke-virtual {v5}, Landroid/graphics/Rect;->height()I

    move-result v5

    iget-object v6, p0, Lzt;->n:Landroid/graphics/Rect;

    iget-object v7, p0, Lzt;->b:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Lzt;->h:Landroid/text/StaticLayout;
    ...
    iget-object v7, p0, Lzt;->o:Landroid/graphics/Rect;

    invoke-static/range {v3 .. v8}, Landroid/view/Gravity;->apply(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V

    iput-boolean v2, p0, Lzt;->r:Z

    :cond_9
    invoke-virtual {p1}, Landroid/graphics/Canvas;->save()I

    iget-object p2, p0, Lzt;->o:Landroid/graphics/Rect;

    iget p2, p2, Landroid/graphics/Rect;->left:I

    int-to-float p2, p2

    iget-object v0, p0, Lzt;->o:Landroid/graphics/Rect;
...
.method public final a(Landroid/text/Layout$Alignment;)V
    ...
    iget-object v0, p0, Lzt;->m:Landroid/text/Layout$Alignment;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Lzt;->m:Landroid/text/Layout$Alignment;
...
.method public final a(Landroid/text/TextPaint;)V
    ...
    iput-object p1, p0, Lzt;->c:Landroid/text/TextPaint;
...
.method public final a(Ljava/lang/CharSequence;)V
    ...
    iget-object p1, p0, Lzt;->e:Ljava/lang/CharSequence;

    invoke-static {p1}, Lzt;->b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
