...
.method static b(Ljava/nio/ByteBuffer;II)Ljava/lang/String;
    ...
    invoke-static {v3, p2, v2}, Lqrg;->a(B[CI)V
    ...
    invoke-static {p1, p2, v8}, Lqrg;->a(B[CI)V
    ...
    invoke-static {v2, p2, v8}, Lqrg;->a(B[CI)V
    ...
    :cond_4
    invoke-static {p1}, Lqrg;->b(B)Z

    move-result v3

    if-nez v3, :cond_8

    invoke-static {p1}, Lqrg;->c(B)Z
    ...
    invoke-static {p1, v2, v3, p2, v8}, Lqrg;->a(BBB[CI)V
    ...
    invoke-static/range {v2 .. v7}, Lqrg;->a(BBBB[CI)V
    ...
    invoke-static {p1, v2, p2, v8}, Lqrg;->a(BB[CI)V
...
.method static b(Ljava/lang/CharSequence;Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {v3, v2, v0}, Lqrl;-><init>(II)V
...
.method final c([BII)Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lqrj;->a([BII)I
