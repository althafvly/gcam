...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lxp;->e:Landroid/support/v7/widget/RecyclerView;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    sget-object v0, Landroid/support/v7/widget/RecyclerView;->J:Landroid/view/animation/Interpolator;

    iput-object v0, p0, Lxp;->d:Landroid/view/animation/Interpolator;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lxp;->f:Z

    iput-boolean v0, p0, Lxp;->g:Z
    ...
    iput-object v0, p0, Lxp;->c:Landroid/widget/OverScroller;
...
.method private final c()V
    ...
    iget-object v0, p0, Lxp;->e:Landroid/support/v7/widget/RecyclerView;
...
.method public final b()V
    ...
    iget-object v0, p0, Lxp;->c:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    invoke-virtual/range {p0 .. p0}, Lxp;->b()V
    ...
    iput-boolean v3, v0, Lxp;->f:Z

    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView;->c()V

    iget-object v1, v0, Lxp;->c:Landroid/widget/OverScroller;
    ...
    iget-object v7, v0, Lxp;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v10, v7, Landroid/support/v7/widget/RecyclerView;->I:[I
    ...
    iget-object v4, v0, Lxp;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->I:[I
    ...
    iget-object v7, v4, Landroid/support/v7/widget/RecyclerView;->j:Lwt;

    if-eqz v7, :cond_3

    iget-object v7, v4, Landroid/support/v7/widget/RecyclerView;->I:[I
    ...
    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->k:Lxb;
    ...
    :cond_4
    iget-object v14, v0, Lxp;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v14, Landroid/support/v7/widget/RecyclerView;->I:[I
    ...
    iget-object v9, v4, Landroid/support/v7/widget/RecyclerView;->I:[I
    ...
    iget-object v8, v7, Landroid/support/v7/widget/RecyclerView;->k:Lxb;
    ...
    :goto_6
    iget-object v5, v0, Lxp;->e:Landroid/support/v7/widget/RecyclerView;
    ...
    :goto_9
    invoke-static {v5}, Lml;->e(Landroid/view/View;)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->B:Lvj;

    invoke-virtual {v1}, Lvj;->a()V

    goto :goto_a

    :cond_17
    invoke-virtual/range {p0 .. p0}, Lxp;->a()V

    iget-object v1, v0, Lxp;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v1, Landroid/support/v7/widget/RecyclerView;->A:Lvh;

    if-eqz v4, :cond_18

    invoke-virtual {v4, v1, v6, v13}, Lvh;->a(Landroid/support/v7/widget/RecyclerView;II)V

    :cond_18
    :goto_a
    iget-object v1, v0, Lxp;->e:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v1, Landroid/support/v7/widget/RecyclerView;->k:Lxb;

    iput-boolean v2, v0, Lxp;->f:Z

    iget-boolean v4, v0, Lxp;->g:Z

    if-eqz v4, :cond_19

    invoke-direct/range {p0 .. p0}, Lxp;->c()V
