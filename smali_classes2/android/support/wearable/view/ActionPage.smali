...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v2, v1}, Laaf;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, Landroid/support/wearable/view/ActionPage;->b:Laaf;

    new-instance v2, Laab;

    invoke-direct {v2, v1}, Laab;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, Landroid/support/wearable/view/ActionPage;->a:Laab;

    iget-object v2, v0, Landroid/support/wearable/view/ActionPage;->a:Laab;

    const/16 v3, 0x11

    invoke-virtual {v2, v3}, Laab;->b(I)V

    iget-object v2, v0, Landroid/support/wearable/view/ActionPage;->a:Laab;

    const/4 v4, 0x2

    invoke-virtual {v2, v4}, Laab;->a(I)V

    sget-object v2, Lyy;->m:[I
    ...
    iget-object v15, v0, Landroid/support/wearable/view/ActionPage;->b:Laaf;

    invoke-virtual {v2, v14}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v14

    iput-object v14, v15, Laaf;->b:Landroid/content/res/ColorStateList;

    iget-object v14, v15, Laaf;->a:Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {v14}, Landroid/graphics/drawable/ShapeDrawable;->getPaint()Landroid/graphics/Paint;

    move-result-object v14

    iget-object v15, v15, Laaf;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v3, v15, Laaf;->c:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v14, v15, Laaf;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v15}, Laaf;->requestLayout()V

    invoke-virtual {v15}, Laaf;->invalidate()V
    ...
    iget-object v3, v0, Landroid/support/wearable/view/ActionPage;->b:Laaf;

    invoke-virtual {v2, v14, v7}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v14

    iput v14, v3, Laaf;->e:I

    iget-object v14, v3, Laaf;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v14, :cond_5

    invoke-virtual {v3}, Laaf;->invalidate()V

    invoke-virtual {v3}, Laaf;->requestLayout()V
    ...
    invoke-virtual {v3, v14}, Laaf;->a(I)V
    ...
    invoke-virtual {v3, v14}, Laaf;->a(F)V
    ...
    iget-object v3, v0, Landroid/support/wearable/view/ActionPage;->a:Laab;
    ...
    iget-object v15, v3, Laab;->c:Ljava/lang/CharSequence;
    ...
    iput-object v8, v3, Laab;->a:Landroid/text/Layout;

    iput-object v14, v3, Laab;->c:Ljava/lang/CharSequence;

    invoke-virtual {v3}, Laab;->requestLayout()V

    invoke-virtual {v3}, Laab;->invalidate()V
    ...
    invoke-virtual {v3}, Laab;->getContext()Landroid/content/Context;
    ...
    iput-object v14, v3, Laab;->b:Landroid/content/res/ColorStateList;

    invoke-virtual {v3}, Laab;->a()V
    ...
    invoke-virtual {v3, v14}, Laab;->a(I)V
    ...
    invoke-virtual {v3, v14}, Laab;->b(I)V
    ...
    invoke-virtual {v3, v14}, Laaf;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Laab;
    ...
    iput v10, v1, Laab;->d:F

    iget-object v2, v1, Laab;->a:Landroid/text/Layout;

    if-eqz v2, :cond_1c

    iput-object v8, v1, Laab;->a:Landroid/text/Layout;

    invoke-virtual {v1}, Laab;->requestLayout()V

    invoke-virtual {v1}, Laab;->invalidate()V

    :cond_1c
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Laab;

    invoke-virtual {v1, v13, v11, v12}, Laab;->a(Ljava/lang/String;II)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Laab;

    invoke-virtual {v0, v1}, Landroid/support/wearable/view/ActionPage;->addView(Landroid/view/View;)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->b:Laaf;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->b:Laaf;
    ...
    invoke-virtual {p1, p3, p5, v0, v1}, Laaf;->layout(IIII)V
    ...
    iget-object p2, p0, Landroid/support/wearable/view/ActionPage;->a:Laab;

    iget-object p3, p0, Landroid/support/wearable/view/ActionPage;->b:Laaf;

    invoke-virtual {p3}, Laaf;->getBottom()I
    ...
    iget-object p5, p0, Landroid/support/wearable/view/ActionPage;->b:Laaf;

    invoke-virtual {p5}, Laaf;->getBottom()I
    ...
    invoke-virtual {p2, p1, p3, p4, p5}, Laab;->layout(IIII)V
...
.method protected final onMeasure(II)V
    ...
    iget-object v0, p0, Landroid/support/wearable/view/ActionPage;->b:Laaf;
    ...
    iget-object v1, v0, Laaf;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1, v1}, Laaf;->measure(II)V

    iget-object v0, p0, Landroid/support/wearable/view/ActionPage;->b:Laaf;

    invoke-virtual {v0}, Laaf;->getMeasuredWidth()I

    move-result v0

    iget-object v1, p0, Landroid/support/wearable/view/ActionPage;->b:Laaf;

    invoke-virtual {v1}, Laaf;->getMeasuredHeight()I
    ...
    invoke-virtual {v1, v0, v2}, Laaf;->measure(II)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->a:Laab;
    ...
    invoke-virtual {p1, p2, v0}, Laab;->measure(II)V
...
.method public final setEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Laaf;->setEnabled(Z)V
...
.method public final setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v0, p1}, Laaf;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public final setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    invoke-virtual {v0, p1}, Laaf;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
