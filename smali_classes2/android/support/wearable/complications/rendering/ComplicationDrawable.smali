...
.field public mComplicationRenderer:Lzk;
...
.field public final mRendererInvalidateListener:Lzq;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lzi;-><init>(Landroid/support/wearable/complications/rendering/ComplicationDrawable;)V
    ...
    invoke-direct {v0, p0}, Lzh;-><init>(Landroid/support/wearable/complications/rendering/ComplicationDrawable;)V

    iput-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRendererInvalidateListener:Lzq;
...
.method public synthetic constructor <init>(Landroid/os/Parcel;Lzg;)V
    .locals 0
...
.method private updateStyleIfRequired()V
    ...
    iget-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lzk;
    ...
    invoke-virtual {v0, v1, v2}, Lzk;->a(Landroid/support/wearable/complications/rendering/ComplicationStyle;Landroid/support/wearable/complications/rendering/ComplicationStyle;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v8, v0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lzk;
    ...
    iget-object v6, v8, Lzk;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Lzk;->c:Landroid/graphics/Rect;
    ...
    iget-object v3, v8, Lzk;->w:Lzp;

    iget-boolean v6, v3, Lzp;->j:Z

    if-ne v6, v4, :cond_1

    iget-boolean v3, v3, Lzp;->k:Z
    ...
    iget-object v6, v8, Lzk;->z:Landroid/support/wearable/complications/rendering/ComplicationStyle;

    invoke-direct {v3, v6, v12, v4, v5}, Lzp;-><init>(Landroid/support/wearable/complications/rendering/ComplicationStyle;ZZZ)V

    iput-object v3, v8, Lzk;->w:Lzp;
    ...
    :cond_3
    iget-object v3, v8, Lzk;->v:Lzp;

    move-object v10, v3

    :goto_0
    iget-object v3, v8, Lzk;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v3, v8, Lzk;->l:Lzt;

    invoke-virtual {v3, v12}, Lzt;->b(I)V

    iget-object v3, v8, Lzk;->l:Lzt;

    iget-object v5, v8, Lzk;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Lzk;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3, v5}, Lzt;->a(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v4}, Lzt;->a(Ljava/lang/CharSequence;)V
    ...
    iget-object v4, v8, Lzk;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v5, v8, Lzk;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3, v1}, Lzt;->a(Ljava/lang/CharSequence;)V

    iget-object v1, v8, Lzk;->l:Lzt;

    invoke-virtual {v1, v12}, Lzt;->b(I)V

    goto :goto_2

    :cond_6
    iget-object v1, v8, Lzk;->m:Lzt;

    invoke-virtual {v1, v4}, Lzt;->a(Ljava/lang/CharSequence;)V

    iget-object v1, v8, Lzk;->l:Lzt;

    invoke-virtual {v1, v11}, Lzt;->b(I)V

    :cond_7
    :goto_2
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/Canvas;->save()I

    iget-object v1, v8, Lzk;->c:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    int-to-float v1, v1

    iget-object v2, v8, Lzk;->c:Landroid/graphics/Rect;
    ...
    iget-object v1, v10, Lzp;->h:Landroid/support/wearable/complications/rendering/ComplicationStyle;

    invoke-virtual {v8, v1}, Lzk;->a(Landroid/support/wearable/complications/rendering/ComplicationStyle;)I

    move-result v1

    int-to-float v2, v1

    iget-object v3, v8, Lzk;->o:Landroid/graphics/RectF;

    iget-object v4, v10, Lzp;->f:Landroid/graphics/Paint;

    invoke-virtual {v7, v3, v2, v2, v4}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V

    iget-object v2, v10, Lzp;->h:Landroid/support/wearable/complications/rendering/ComplicationStyle;
    ...
    invoke-virtual {v10}, Lzp;->a()Z

    move-result v2

    if-nez v2, :cond_8

    iget-object v2, v8, Lzk;->i:Lzu;

    iget-object v3, v10, Lzp;->h:Landroid/support/wearable/complications/rendering/ComplicationStyle;
    ...
    invoke-virtual {v2, v3}, Lzu;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v2, v8, Lzk;->i:Lzu;

    iput v1, v2, Lzu;->a:I

    iget-object v1, v8, Lzk;->n:Landroid/graphics/Rect;

    invoke-virtual {v2, v1}, Lzu;->setBounds(Landroid/graphics/Rect;)V

    iget-object v1, v8, Lzk;->i:Lzu;

    invoke-virtual {v1, v7}, Lzu;->draw(Landroid/graphics/Canvas;)V

    :cond_8
    iget-object v1, v8, Lzk;->p:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lzk;->d:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v8, Lzk;->e:Landroid/graphics/drawable/Drawable;
    ...
    :goto_3
    iget-object v3, v10, Lzp;->l:Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v3}, Landroid/graphics/drawable/Drawable;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v3, v8, Lzk;->p:Landroid/graphics/Rect;
    ...
    :cond_b
    iget-object v1, v8, Lzk;->q:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lzk;->k:Lzu;

    iget-object v3, v8, Lzk;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lzu;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lzk;->f:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v8, Lzk;->g:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lzu;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lzk;->g:Landroid/graphics/drawable/Drawable;
    ...
    :cond_d
    :goto_4
    iget-object v1, v8, Lzk;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    invoke-virtual {v1, v3}, Lzu;->setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    invoke-virtual {v1, v2}, Lzu;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v1, v8, Lzk;->k:Lzu;

    iget-object v2, v10, Lzp;->h:Landroid/support/wearable/complications/rendering/ComplicationStyle;

    iget-object v3, v8, Lzk;->q:Landroid/graphics/Rect;

    invoke-virtual {v8, v2, v3}, Lzk;->a(Landroid/support/wearable/complications/rendering/ComplicationStyle;Landroid/graphics/Rect;)I
    ...
    iget-object v2, v8, Lzk;->q:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Lzu;->setBounds(Landroid/graphics/Rect;)V
    ...
    :cond_f
    :goto_6
    iget-object v1, v8, Lzk;->r:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lzk;->j:Lzu;

    iget-object v2, v8, Lzk;->h:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v2}, Lzu;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lzk;->j:Lzu;

    iget-object v2, v10, Lzp;->h:Landroid/support/wearable/complications/rendering/ComplicationStyle;

    iget-object v3, v8, Lzk;->r:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Lzk;->r:Landroid/graphics/Rect;
    ...
    :cond_10
    iget-object v1, v8, Lzk;->u:Landroid/graphics/RectF;
    ...
    iget-object v2, v8, Lzk;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v1, v10, Lzp;->c:Landroid/graphics/Paint;
    ...
    iget-object v2, v8, Lzk;->u:Landroid/graphics/RectF;
    ...
    iget-object v6, v10, Lzp;->c:Landroid/graphics/Paint;
    ...
    iget-object v6, v10, Lzp;->d:Landroid/graphics/Paint;
    ...
    :cond_12
    iget-object v1, v8, Lzk;->s:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lzk;->x:Landroid/text/TextPaint;

    iget-object v2, v10, Lzp;->a:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_13

    iput-object v2, v8, Lzk;->x:Landroid/text/TextPaint;

    iget-object v1, v8, Lzk;->l:Lzt;

    iget-object v2, v8, Lzk;->x:Landroid/text/TextPaint;

    invoke-virtual {v1, v2}, Lzt;->a(Landroid/text/TextPaint;)V

    iget-object v1, v8, Lzk;->l:Lzt;

    iget-boolean v2, v10, Lzp;->i:Z

    invoke-virtual {v1, v2}, Lzt;->a(Z)V

    :cond_13
    iget-object v1, v8, Lzk;->l:Lzt;

    iget-object v2, v8, Lzk;->s:Landroid/graphics/Rect;

    invoke-virtual {v1, v7, v2}, Lzt;->a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    :cond_14
    iget-object v1, v8, Lzk;->t:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lzk;->y:Landroid/text/TextPaint;

    iget-object v2, v10, Lzp;->b:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_15

    iput-object v2, v8, Lzk;->y:Landroid/text/TextPaint;

    iget-object v1, v8, Lzk;->m:Lzt;

    iget-object v2, v8, Lzk;->y:Landroid/text/TextPaint;
    ...
    iget-object v2, v8, Lzk;->t:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Lzk;->o:Landroid/graphics/RectF;

    iget-object v3, v10, Lzp;->g:Landroid/graphics/Paint;
    ...
    iget-object v3, v10, Lzp;->e:Landroid/graphics/Paint;
...
.method getComplicationRenderer()Lzk;
    .locals 1
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Lzk;->a(Landroid/graphics/Rect;)Z
...
.method public onTap(II)Z
    ...
    iget-object v0, v0, Lzk;->b:Landroid/support/wearable/complications/ComplicationData;
...
.method public setComplicationData(Landroid/support/wearable/complications/ComplicationData;)V
    ...
    invoke-virtual {v0, p1}, Lzk;->a(Landroid/support/wearable/complications/ComplicationData;)V
...
.method public setContext(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lzk;-><init>(Landroid/content/Context;Landroid/support/wearable/complications/rendering/ComplicationStyle;Landroid/support/wearable/complications/rendering/ComplicationStyle;)V

    iput-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lzk;

    iget-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lzk;

    iget-object v1, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRendererInvalidateListener:Lzq;

    iput-object v1, v0, Lzk;->A:Lzq;
    ...
    :goto_0
    iget-object p1, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lzk;

    iget-boolean v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRangedValueProgressHidden:Z

    invoke-virtual {p1, v0}, Lzk;->a(Z)V
    ...
    invoke-virtual {p1, v0}, Lzk;->a(Landroid/graphics/Rect;)Z
...
.method public setNoDataText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lzk;->a(Ljava/lang/CharSequence;)V
