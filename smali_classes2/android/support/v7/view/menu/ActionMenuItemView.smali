...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lud;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private final g()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lrd;
    ...
    iget-object v2, v2, Lrd;->k:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lrd;->d:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lrd;->l:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lrd;

    iget-object v1, v0, Lrd;->d:Ljava/lang/CharSequence;
...
.method public final a(Lrd;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lrd;
    ...
    invoke-virtual {p0, v0, v2, v2, v2}, Lud;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V

    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->g()V

    invoke-virtual {p1, p0}, Lrd;->a(Lrr;)Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lvg;

    if-nez p1, :cond_4

    new-instance p1, Lql;

    invoke-direct {p1, p0}, Lql;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lvg;
...
.method public final d()Z
    ...
    invoke-virtual {v0}, Lrd;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lrb;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lrd;

    invoke-interface {p1, v0}, Lrb;->a(Lrd;)Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Lud;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected final onMeasure(II)V
    ...
    invoke-super {p0, v1, v2, v3, v4}, Lud;->setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, v0, v1}, Lud;->setPadding(IIII)V
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1}, Lud;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lrd;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lvg;
    ...
    :cond_0
    invoke-super {p0, p1}, Lud;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public final setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lud;->setPadding(IIII)V
