...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lpr;->bB:[I

    const/4 v2, 0x0

    invoke-static {v0, p2, v1, p3, v2}, Lye;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lye;

    move-result-object p2

    sget p3, Lpr;->bC:I

    invoke-virtual {p2, p3}, Lye;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p3, v0}, Lye;->f(II)I
    ...
    invoke-virtual {p2, p3, v2}, Lye;->a(IZ)Z
...
.method public final a()Lrd;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lrd;
...
.method public final a(Lrd;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lrd;
    ...
    :cond_3
    iget-object v3, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lrd;

    invoke-virtual {v3}, Lrd;->e()Z
    ...
    :cond_a
    :goto_5
    invoke-virtual {p1}, Lrd;->d()Z

    move-result v0

    invoke-virtual {p1}, Lrd;->c()C

    if-eqz v0, :cond_c

    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lrd;

    invoke-virtual {v0}, Lrd;->d()Z
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lrd;

    invoke-virtual {v4}, Lrd;->c()C
    ...
    :cond_d
    iget-object v6, v4, Lrd;->i:Lqz;

    iget-object v6, v6, Lqz;->a:Landroid/content/Context;
    ...
    iget-object v8, v4, Lrd;->i:Lqz;

    iget-object v8, v8, Lqz;->a:Landroid/content/Context;
    ...
    invoke-static {v7, v4, v8, v9}, Lrd;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v7, v4, v2, v8}, Lrd;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    iget-object v3, v3, Lrd;->i:Lqz;

    iget-boolean v3, v3, Lqz;->h:Z
    ...
    :cond_1d
    iget-object p1, p1, Lrd;->k:Ljava/lang/CharSequence;
...
.method protected final onFinishInflate()V
    ...
    invoke-static {p0, v0}, Lml;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
