...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfhv;->i:Landroid/net/Uri;
...
.method constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;)V
    ...
    invoke-static {p1}, Lmem;->a(Landroid/content/Context;)Lmdv;

    move-result-object p1

    iput-object p1, p0, Lfhv;->b:Lmdv;

    iput-object p2, p0, Lfhv;->j:Ljava/util/concurrent/Executor;
...
.method public static a(Landroid/content/Context;)Z
    ...
    :try_start_0
    sget-object v3, Lfhv;->i:Landroid/net/Uri;
    ...
    :goto_2
    :try_start_2
    sget-object v4, Lfhv;->a:Ljava/lang/String;

    const-string v5, "Failed to get \'Use My Location\' setting"

    invoke-static {v4, v5, v3}, Lcub;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
...
.method private final b()V
    ...
    invoke-static {p0, v2}, Lfzl;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v1, v2}, Lfzl;->a(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;

    new-instance v2, Llwh;

    invoke-direct {v2, p0, v1}, Llwh;-><init>(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v0, v2}, Lltw;->a(Llwh;)Lmij;
    ...
    invoke-virtual {v0, v1}, Lmij;->a(Lmht;)Lmij;
    :try_end_1
...
.method public static b(Landroid/location/Location;)Z
    ...
    sget-object p0, Lfhv;->a:Ljava/lang/String;
    ...
    invoke-static {v1, v2}, Lldi;->c(J)F
    ...
    invoke-static {v1, p0}, Lcub;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a()Lqig;
    ...
    iget-object v1, p0, Lfhv;->e:Landroid/location/Location;
    ...
    iget-object v2, p0, Lfhv;->e:Landroid/location/Location;
    ...
    iput-object v2, p0, Lfhv;->e:Landroid/location/Location;
    ...
    iget-object v1, p0, Lfhv;->b:Lmdv;

    invoke-virtual {v1}, Lmdv;->b()Lmij;

    move-result-object v1

    iget-object v2, p0, Lfhv;->j:Ljava/util/concurrent/Executor;

    new-instance v3, Lfhu;

    invoke-direct {v3, p0, v0}, Lfhu;-><init>(Lfhv;Lqiy;)V
...
.method public final a(Z)V
    ...
    iput-boolean p1, p0, Lfhv;->h:Z

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, Lfhv;->b:Lmdv;

    invoke-virtual {p1}, Lmdv;->b()Lmij;

    move-result-object p1

    iget-object v0, p0, Lfhv;->j:Ljava/util/concurrent/Executor;

    new-instance v1, Lfhx;

    invoke-direct {v1, p0}, Lfhx;-><init>(Lfhv;)V

    invoke-virtual {p1, v0, v1}, Lmij;->a(Ljava/util/concurrent/Executor;Lmib;)Lmij;
