...
.method private final declared-synchronized a(J)Z
    ...
    :try_start_0
    iget-object v0, p0, Liwd;->b:Livc;

    if-eqz v0, :cond_0

    iget-wide v0, v0, Livc;->a:J
    :try_end_0
...
# virtual methods
.method public final declared-synchronized a(Livc;)F
    .locals 5
    ...
    invoke-direct {p0, v0, v1}, Liwd;->a(J)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Liwd;->a:Lfuf;

    iget-object v1, p0, Liwd;->b:Livc;

    invoke-interface {v0, v1, p1}, Lfuf;->a(Livc;Livc;)F

    move-result v0

    iget-wide v1, p1, Livc;->a:J

    iget-object v3, p0, Liwd;->b:Livc;
