...
.method public constructor <init>(Lcom/google/android/apps/refocus/viewer/RGBZViewer;Lcom/google/android/apps/refocus/image/RGBZ;Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, Llos;->c:Lcom/google/android/apps/refocus/viewer/RGBZViewer;

    iput-object p2, p0, Llos;->a:Lcom/google/android/apps/refocus/image/RGBZ;

    iput-object p3, p0, Llos;->b:Ljava/lang/Runnable;
...
.method public final run()V
    ...
    iget-object v0, p0, Llos;->c:Lcom/google/android/apps/refocus/viewer/RGBZViewer;

    iget-object v1, p0, Llos;->a:Lcom/google/android/apps/refocus/image/RGBZ;
    ...
    invoke-direct {v2, v3}, Lloj;-><init>(Lcom/google/android/apps/refocus/image/RGBZ;)V

    iput-object v2, v0, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->h:Lloj;
    ...
    iget-object v4, v0, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->b:Lcot;

    invoke-direct {v2, v3, v4}, Lcom/google/android/apps/refocus/processing/FaceDetector;-><init>(Landroid/content/Context;Lcot;)V

    iget-object v3, v0, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->e:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;

    iget-object v3, v3, Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;->rgbz:Lcom/google/android/apps/refocus/image/RGBZ;

    iget-object v4, v0, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->h:Lloj;

    invoke-static {v2, v3, v4}, Lcom/google/android/apps/refocus/processing/FocusSettings;->createDefault(Lcom/google/android/apps/refocus/processing/FaceDetector;Lcom/google/android/apps/refocus/image/RGBZ;Lloj;)Lcom/google/android/apps/refocus/processing/FocusSettings;
    ...
    :goto_0
    iget-object v2, v0, Lcom/google/android/apps/refocus/viewer/RGBZViewer;->h:Lloj;
    ...
    invoke-virtual {v2, v4, v5}, Lloj;->a(FF)F
    ...
    :cond_4
    :goto_3
    iget-object v0, p0, Llos;->b:Ljava/lang/Runnable;
