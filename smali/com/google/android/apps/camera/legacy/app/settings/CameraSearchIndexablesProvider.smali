...
.method private final declared-synchronized b()Lfax;
    .locals 2

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lfax;
    ...
    invoke-interface {v0}, Lfaz;->a()Lfax;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lfax;
    ...
    invoke-virtual {v0, v1}, Lfax;->a(Landroid/content/Context;)V
...
.method public final queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b()Lfax;

    move-result-object v0

    invoke-virtual {v0}, Lfax;->a()Ljava/util/List;
...
.method public final queryRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-interface {p1}, Lplg;->g()Ljava/util/Collection;
