...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p1, p0, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->f:I
    ...
    iput p2, p0, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->c:F
    ...
    iput-object p2, p0, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->e:Landroid/graphics/Bitmap;
    ...
    iput-object p2, p0, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->b:Landroid/graphics/Paint;

    iget-object p2, p0, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->b:Landroid/graphics/Paint;

    invoke-virtual {p2, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->b:Landroid/graphics/Paint;
...
.method protected final declared-synchronized onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, v1, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->e:Landroid/graphics/Bitmap;
    ...
    iget-object v4, v1, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->e:Landroid/graphics/Bitmap;
    ...
    :cond_0
    iget v3, v1, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->c:F
    ...
    iget-object v15, v1, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->b:Landroid/graphics/Paint;
...
.method protected final declared-synchronized onMeasure(II)V
    ...
    :goto_0
    iget p2, p0, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->f:I
...
.method public final setMaxWidth(I)V
    ...
    iget v0, p0, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->f:I

    if-eq v0, p1, :cond_0

    iput p1, p0, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->f:I

    invoke-virtual {p0}, Lcom/google/android/apps/camera/zoomui/ZoomSeekBar;->requestLayout()V
