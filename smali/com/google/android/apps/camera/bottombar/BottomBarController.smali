...
.field public final leftCancelButton:Landroid/widget/ImageButton;
...
.method public constructor <init>(Lcom/google/android/apps/camera/bottombar/BottomBar;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/google/android/apps/camera/bottombar/BottomBarController;-><init>(Lcom/google/android/apps/camera/bottombar/BottomBar;Ljvg;Z)V

    return-void
.end method

.method public constructor <init>(Lcom/google/android/apps/camera/bottombar/BottomBar;Ljvg;Z)V
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Lcom/google/android/apps/camera/bottombar/BottomBarController$$Lambda$0;-><init>(Lcom/google/android/apps/camera/bottombar/BottomBar;Ljvg;)V

    invoke-virtual {p1, v0}, Lcom/google/android/apps/camera/bottombar/BottomBar;->post(Ljava/lang/Runnable;)Z

    if-eqz p3, :cond_0

    invoke-virtual {p1}, Lcom/google/android/apps/camera/bottombar/BottomBar;->setBottomBarConstant()V
...
.method static final synthetic lambda$new$0$BottomBarController(Lcom/google/android/apps/camera/bottombar/BottomBar;Ljvg;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/google/android/apps/camera/bottombar/BottomBar;->setSysUiFlagApplier(Ljvg;)V
...
.method public getBackgroundColorProperty()Llaz;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/google/android/apps/camera/bottombar/BottomBar;->getBackgroundColorProperty()Llaz;
...
.method public getCameraSwitchColorProperty()Llaz;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/google/android/apps/camera/bottombar/CameraSwitchButton;->getCameraSwitchColorProperty()Llaz;
...
.method final synthetic lambda$wireListeners$10$BottomBarController(Landroid/view/View;)V
    .locals 0
...
.method final synthetic lambda$wireListeners$6$BottomBarController(Landroid/view/View;I)V
    .locals 0
...
.method public startImaxCapture(Z)V
    ...
    invoke-virtual {v0}, Lcom/google/android/apps/camera/bottombar/BottomBar;->getUiOrientation()Llbp;
...
.method public switchToMode(Llaw;)V
    .locals 3
    ...
    invoke-virtual {p1, v1}, Llaw;->equals(Ljava/lang/Object;)Z
