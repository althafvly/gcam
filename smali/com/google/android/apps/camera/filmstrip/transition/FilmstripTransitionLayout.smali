...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->g:Lbpv;

    iput-object p2, p0, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->h:Lbpv;

    invoke-static {}, Lnsm;->a()Lnsm;

    move-result-object p2

    iput-object p2, p0, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->m:Lnsm;
    ...
    invoke-direct {v3, p0}, Ldlg;-><init>(Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;)V
    ...
    invoke-direct {v3, p0}, Ldli;-><init>(Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;)V
    ...
    invoke-direct {p2, p0}, Ldlh;-><init>(Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;)V
    ...
    invoke-direct {p2, p0}, Ldlj;-><init>(Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;)V
...
.method public final a(F)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->j:Ldll;

    invoke-static {v0}, Lplj;->d(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->j:Ldll;

    invoke-virtual {v0, p1}, Ldll;->a(F)F
    ...
    invoke-virtual {v0, p1}, Ldll;->b(F)Landroid/graphics/PointF;
    ...
    invoke-virtual {v0, p1}, Ldll;->c(F)F
    ...
    invoke-virtual {v0, p1}, Ldll;->d(F)F
...
.method public final a(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->d()Ldlk;

    move-result-object p1

    invoke-virtual {p1}, Ldlk;->a()Ldll;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->j:Ldll;
...
.method public final a(Landroid/graphics/Bitmap;Lbpv;)V
    .locals 0
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->k:Ldle;
...
.method public final d()Ldlk;
    ...
    invoke-static {v1}, Llbr;->b(Landroid/view/View;)I
    ...
    invoke-static {v1}, Llbo;->a(Landroid/view/View;)[I
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->m:Lnsm;

    iget-boolean v1, v1, Lnsm;->e:Z
    ...
    invoke-direct/range {v1 .. v6}, Ldlk;-><init>(Landroid/util/SizeF;Landroid/graphics/RectF;Landroid/graphics/RectF;Landroid/graphics/RectF;F)V
...
.method public final e()V
    ...
    invoke-virtual {v0}, Ldlk;->a()Ldll;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->j:Ldll;
...
.method public final f()V
    ...
    invoke-virtual {v0, v1}, Ldll;->a(F)F
    ...
    invoke-virtual {v0, v1}, Ldll;->b(F)Landroid/graphics/PointF;
    ...
    invoke-virtual {v0, v1}, Ldll;->c(F)F
    ...
    invoke-virtual {v0, v1}, Ldll;->d(F)F
