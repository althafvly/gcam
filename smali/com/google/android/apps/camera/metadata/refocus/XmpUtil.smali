...
.method public static createXMPMeta()Lago;
    .locals 1
...
.method public static extractOrCreateXMPMeta(Ljava/lang/String;)Lago;
    .locals 0

    invoke-static {p0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/lang/String;)Lago;
...
.method private static extractXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Z)Lago;
    .locals 5
    ...
    invoke-static {p0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->parseFirstValidXMPSection(Ljava/util/List;)Lago;
    ...
    invoke-interface {v1, v3, v2}, Lago;->e(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-interface {v1, v3, v2}, Lago;->a(Ljava/lang/String;Ljava/lang/String;)Laib;

    move-result-object v2

    invoke-interface {v2}, Laib;->c()Ljava/lang/Object;
    ...
    invoke-static {p0, v2}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->parseExtendedXMPSections(Ljava/util/List;Ljava/lang/String;)Lago;
    ...
    :try_start_1
    invoke-interface {p0}, Lago;->a()Lagl;

    move-result-object p0

    :cond_0
    :goto_0
    invoke-interface {p0}, Lagl;->next()Ljava/lang/Object;
    ...
    invoke-interface {p1}, Laie;->b()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-interface {p1}, Laie;->a()Ljava/lang/String;
    ...
    invoke-interface {p1}, Laie;->c()Ljava/lang/Object;

    move-result-object v3

    invoke-interface {p1}, Laie;->d()Laia;

    move-result-object p1

    invoke-interface {v1, v0, v2, v3, p1}, Lago;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Laia;)V
    :try_end_1
    ...
    invoke-static {p0}, Lqjh;->a(Ljava/lang/Throwable;)V
...
.method public static extractXMPMeta(Ljava/io/InputStream;)Lago;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/io/InputStream;Z)Lago;
...
.method public static extractXMPMeta(Ljava/io/InputStream;Z)Lago;
    .locals 1
    ...
    invoke-static {v0, p1}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Z)Lago;
...
.method public static extractXMPMeta(Ljava/lang/String;)Lago;
    .locals 8
...
.method public static extractXMPMeta([B)Lago;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta([BZ)Lago;
...
.method public static extractXMPMeta([BZ)Lago;
    .locals 1
...
.method private static parse(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;ZZ)Ljava/util/List;
    ...
    :try_start_4
    invoke-interface {p0, v4}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;->readRemaining(I)Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$Section;
...
.method private static parseExtendedXMPSections(Ljava/util/List;Ljava/lang/String;)Lago;
    .locals 9
    ...
    :cond_2
    :try_start_0
    invoke-static {p1}, Lagn;->a([B)Lago;
...
.method private static parseFirstValidXMPSection(Ljava/util/List;)Lago;
    .locals 8
...
.method private static serializeMeta(Lago;)[B
    .locals 6
    ...
    invoke-virtual {v0}, Lahz;->e()Lahz;

    invoke-virtual {v0}, Lahz;->c()Lahz;

    invoke-static {p0, v0}, Lagn;->a(Lago;Lahz;)[B
...
.method private static writeXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Ljava/io/OutputStream;Lago;Lago;)Z
    .locals 11
    ...
    invoke-static {p3}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->serializeMeta(Lago;)[B
    ...
    :try_start_0
    invoke-interface {p2, v2, v1, v4}, Lago;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Lagm; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    invoke-static {p2}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->serializeMeta(Lago;)[B
    ...
    invoke-interface {p2, v2, v1}, Lago;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static writeXMPMeta(Ljava/io/InputStream;Ljava/io/OutputStream;Lago;Lago;)Z
    .locals 1
    ...
    invoke-static {v0, p1, p2, p3}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->writeXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Ljava/io/OutputStream;Lago;Lago;)Z
...
.method public static writeXMPMeta(Ljava/lang/String;Lago;)Z
    .locals 9
    ...
    :try_start_2
    invoke-static {v1, v2, p1, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->writeXMPMeta(Ljava/io/InputStream;Ljava/io/OutputStream;Lago;Lago;)Z
...
.method public static writeXMPMeta([BLjava/io/OutputStream;Lago;Lago;)Z
    .locals 1
