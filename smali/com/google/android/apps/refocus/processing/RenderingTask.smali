...
.method public constructor <init>(Landroid/net/Uri;Lcom/google/android/apps/refocus/processing/FocusSettings;Lcom/google/android/apps/refocus/image/RGBZ;Ljava/lang/String;Landroid/location/Location;Lcom/google/android/apps/refocus/processing/FaceDetector;Landroid/content/ContentResolver;Ljfe;Ljei;)V
    .locals 0
    ...
    invoke-direct {p7, p8, p2, p1}, Ljfj;-><init>(Ljfe;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface/range {p2 .. p7}, Ljei;->a(Ljava/lang/String;Lmrv;JLjfj;)Ljef;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/refocus/processing/RenderingTask;->session:Ljef;
...
.method private processInternal(Landroid/content/Context;Ljef;)V
    .locals 5
    ...
    sget-object v2, Ljca;->LENS_BLUR_RERENDER:Ljca;

    invoke-virtual {p2, v0, v1, v2}, Ljef;->a(Landroid/net/Uri;Lkty;Ljca;)V

    new-instance v0, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;

    invoke-direct {v0, p2}, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;-><init>(Ljay;)V
    ...
    invoke-virtual {v0, v1}, Lndq;->a(Landroid/location/Location;)V
    ...
    invoke-direct {v1, v2, v3}, Ljsp;-><init>(Lnaj;Lntr;)V
    ...
    invoke-virtual {v1, p1}, Ljsp;->a(Lcom/google/android/libraries/camera/exif/ExifInterface;)Ljsp;

    sget-object p1, Lnaf;->CLOCKWISE_0:Lnaf;

    invoke-virtual {v1, p1}, Ljsp;->a(Lnaf;)Ljsp;

    invoke-virtual {p2, v0, v1}, Ljef;->a(Ljava/io/InputStream;Ljsp;)Lqig;
...
.method public getSession()Lirf;
    ...
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/RenderingTask;->session:Ljef;
...
.method public process(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/apps/refocus/processing/RenderingTask;->processInternal(Landroid/content/Context;Ljef;)V
