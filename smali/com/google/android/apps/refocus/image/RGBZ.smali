...
.field public depthmapData:Llnv;
...
.method private finishParsingXMPMeta()V
    ...
    invoke-static {v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/io/InputStream;)Lago;
    ...
    :cond_0
    invoke-static {}, Llnx;->a()V

    const-string v3, "Mime"

    const-string v4, "http://ns.google.com/photos/1.0/image/"

    invoke-interface {v0, v4, v3}, Lago;->e(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v0, v4, v5}, Lago;->e(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v6

    if-eqz v6, :cond_2

    new-instance v6, Llnx;

    invoke-direct {v6}, Llnx;-><init>()V

    :try_start_1
    invoke-interface {v0, v4, v3}, Lago;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v6, Llnx;->a:Ljava/lang/String;

    const-string v3, "image/png"

    iget-object v7, v6, Llnx;->a:Ljava/lang/String;
    ...
    iget-object v3, v6, Llnx;->a:Ljava/lang/String;
    ...
    :cond_1
    invoke-interface {v0, v4, v5}, Lago;->j(Ljava/lang/String;Ljava/lang/String;)[B

    move-result-object v3

    iput-object v3, v6, Llnx;->b:[B
    :try_end_1
    ...
    :goto_1
    iput-object v6, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData:Llnx;

    iget-object v3, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData:Llnx;
    ...
    :goto_2
    iput-object v3, p0, Lcom/google/android/apps/refocus/image/RGBZ;->bitmap:Landroid/graphics/Bitmap;

    :goto_3
    invoke-static {v0}, Llnv;->a(Lago;)Llnv;

    move-result-object v3

    iput-object v3, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Llnv;

    iget-object v3, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Llnv;
    ...
    :cond_5
    iget-object v5, v3, Llnv;->c:Lcom/google/android/apps/camera/metadata/refocus/DepthTransform;
    ...
    iget-object v6, v3, Llnv;->b:[B

    if-eqz v6, :cond_9

    if-eqz v5, :cond_9

    iget-object v6, v3, Llnv;->a:Ljava/lang/String;
    ...
    :cond_a
    invoke-static {}, Llny;->a()V

    const-string v2, "FocalDistance"

    const-string v3, "http://ns.google.com/photos/1.0/focus/"

    invoke-interface {v0, v3, v2}, Lago;->e(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v0, v3, v4}, Lago;->e(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_2
    invoke-interface {v0, v3, v2}, Lago;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Double;
    ...
    invoke-interface {v0, v3, v4}, Lago;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Double;
    ...
    invoke-interface {v0, v3, v1}, Lago;->e(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_3
    invoke-interface {v0, v3, v1}, Lago;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Double;
    ...
    :cond_c
    :goto_8
    invoke-static {v5}, Llny;->a(Lcom/google/android/apps/refocus/processing/FocusSettings;)Llny;
    ...
    iget-object v0, v1, Llny;->a:Lcom/google/android/apps/refocus/processing/FocusSettings;
...
.method private writeXMPMeta(ILcom/google/android/libraries/camera/exif/ExifInterface;Ljava/io/OutputStream;)V
    ...
    invoke-static {}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->createXMPMeta()Lago;
    ...
    invoke-static {v3}, Llny;->a(Lcom/google/android/apps/refocus/processing/FocusSettings;)Llny;
    ...
    iget-object v5, v3, Llny;->a:Lcom/google/android/apps/refocus/processing/FocusSettings;
    ...
    invoke-interface {p2, v2, v4, v5}, Lago;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object v3, v3, Llny;->a:Lcom/google/android/apps/refocus/processing/FocusSettings;
    ...
    invoke-interface {p2, v2, v4, v3}, Lago;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-static {v2}, Lqjh;->a(Ljava/lang/Throwable;)V
    ...
    iput-object v4, v5, Llnx;->a:Ljava/lang/String;
    ...
    iput-object v3, v5, Llnx;->b:[B

    iput-object v5, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData:Llnx;
    ...
    :try_start_1
    invoke-interface {p2, v0, v6, v4}, Lago;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v3, v3, Llnx;->b:[B

    invoke-interface {v2, v0, v5, v3}, Lago;->a(Ljava/lang/String;Ljava/lang/String;[B)V
    :try_end_1
    ...
    iget-object v0, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Llnv;
    ...
    invoke-static {p0}, Llnv;->a(Lcom/google/android/apps/refocus/image/RGBZ;)Llnv;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Llnv;
    ...
    iget-object v4, v0, Llnv;->c:Lcom/google/android/apps/camera/metadata/refocus/DepthTransform;

    invoke-interface {v4}, Lcom/google/android/apps/camera/metadata/refocus/DepthTransform;->getFormat()Ljava/lang/String;

    move-result-object v4

    invoke-interface {p2, v1, v3, v4}, Lago;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {p2, v1, v3, v7, v8}, Lago;->a(Ljava/lang/String;Ljava/lang/String;D)V
    ...
    iget-object v3, v0, Llnv;->a:Ljava/lang/String;

    invoke-interface {p2, v1, v6, v3}, Lago;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v0, v0, Llnv;->b:[B

    invoke-interface {v2, v1, v5, v0}, Lago;->a(Ljava/lang/String;Ljava/lang/String;[B)V
    :try_end_2
    .catch Lagm; {:try_start_2 .. :try_end_2} :catch_2
    ...
    sget-object v0, Ldqk;->REFOCUS:Ldqk;

    invoke-virtual {v0}, Ldqk;->f()Ljava/lang/String;

    move-result-object v0

    invoke-static {p2, v0}, Lfmy;->a(Lago;Ljava/lang/String;)Z
    ...
    :goto_3
    invoke-static {p1, p3, p2, v2}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->writeXMPMeta(Ljava/io/InputStream;Ljava/io/OutputStream;Lago;Lago;)Z
