...
.method constructor <init>(Landroid/content/Context;Lmrj;Ljvb;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ljuf;->b:Landroid/content/Context;

    iput-object p2, p0, Ljuf;->c:Lmrj;

    iput-object p3, p0, Ljuf;->d:Ljvb;
...
.method private final a(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    iget-object v1, p0, Ljuf;->b:Landroid/content/Context;
    ...
    iget-object p2, p0, Ljuf;->b:Landroid/content/Context;
    ...
    invoke-direct {v0, p0}, Ljuk;-><init>(Ljuf;)V
...
.method public final a(Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    ...
    iget-object v0, p0, Ljuf;->b:Landroid/content/Context;
    ...
    invoke-direct {p0, v0, v1, p1}, Ljuf;->a(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object p1

    invoke-static {p1}, Ljuf;->a(Landroid/app/AlertDialog$Builder;)Landroid/app/AlertDialog;
...
.method public final c(Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    ...
    invoke-direct {p0, v0, v1, p1}, Ljuf;->b(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
...
.method public final f(Landroid/content/DialogInterface$OnClickListener;)Lqig;
    .locals 2

    iget-object v0, p0, Ljuf;->d:Ljvb;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Ljvb;->a(Z)Lqig;

    move-result-object v0

    invoke-virtual {p0, p1}, Ljuf;->e(Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;

    move-result-object p1

    new-instance v1, Ljui;

    invoke-direct {v1, p0, p1}, Ljui;-><init>(Ljuf;Landroid/app/AlertDialog;)V
