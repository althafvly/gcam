...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lltk;->d:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lltk;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lltk;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)I
    ...
    :cond_0
    sget-object v0, Lltk;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v0, Llze;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_1
    sget-boolean v2, Llze;->b:Z
    ...
    :try_start_2
    invoke-virtual {v3, v2, v4}, Lman;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    sget-object v0, Lmab;->a:Ljava/lang/Boolean;
    ...
    sput-object v0, Lmab;->a:Ljava/lang/Boolean;
    ...
    invoke-static {p0, v0, p1}, Lltk;->a(Landroid/content/Context;ZI)I
...
.method private static a(Landroid/content/Context;ZI)I
    ...
    invoke-static {p0}, Lltn;->a(Landroid/content/Context;)Lltn;

    invoke-static {v7, v1}, Lltn;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v6, v1}, Lltn;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lmaf;->a(I)I

    move-result p0

    invoke-static {p2}, Lmaf;->a(I)I
...
.method public static a(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Llsx;->a(I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v3, v4}, Lman;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v0, v1}, Lltn;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lltn;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lltk;->c:Z
...
.method public static b(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lltk;->a(Landroid/content/Context;Ljava/lang/String;)Z
