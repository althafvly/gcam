...
.method public constructor <init>(Landroid/hardware/SensorManager;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Ljap;->a:Landroid/hardware/SensorManager;

    iput-object p2, p0, Ljap;->c:Ljava/util/concurrent/Executor;
    ...
    :goto_0
    iput-object p2, p0, Ljap;->b:Landroid/hardware/Sensor;
...
.method public final a(Landroid/hardware/SensorEventListener;)Z
    ...
    iget-object v0, p0, Ljap;->b:Landroid/hardware/Sensor;

    if-eqz v0, :cond_0

    iget-object v0, p0, Ljap;->c:Ljava/util/concurrent/Executor;

    new-instance v1, Ljao;

    invoke-direct {v1, p0, p1}, Ljao;-><init>(Ljap;Landroid/hardware/SensorEventListener;)V
...
.method public final b(Landroid/hardware/SensorEventListener;)V
    ...
    invoke-direct {v1, p0, p1}, Ljar;-><init>(Ljap;Landroid/hardware/SensorEventListener;)V
