...
# direct methods
.method constructor <init>(Ldzv;Lnto;)V
    .locals 0
...
.method public final run()V
    ...
    iget-object v1, p0, Ldzu;->b:Lnto;

    iget-object v2, v0, Ldzv;->b:Ldzs;
    ...
    invoke-static {v3, v5}, Lplj;->a(ZLjava/lang/Object;)V

    iget-object v3, v2, Ldzs;->c:Lnba;

    const-string v5, "YUV to Bitmap"

    invoke-interface {v3, v5}, Lnba;->b(Ljava/lang/String;)V

    iget-object v3, v2, Ldzs;->a:Lcom/google/googlex/gcam/hdrplus/ImageConverter;

    invoke-virtual {v3, v1}, Lcom/google/googlex/gcam/hdrplus/ImageConverter;->wrapYuvWriteView(Lnto;)Lcom/google/googlex/gcam/YuvWriteView;
    ...
    invoke-virtual {v5}, Lcom/google/googlex/gcam/InterleavedReadViewU8;->width()I

    move-result v11

    invoke-virtual {v5}, Lcom/google/googlex/gcam/InterleavedReadViewU8;->height()I
    ...
    invoke-virtual/range {v7 .. v13}, Lcom/google/googlex/gcam/InterleavedReadViewU8;->FastCrop(IIIIII)V
    ...
    invoke-interface {v3, v5}, Lnba;->c(Ljava/lang/String;)V

    iget-object v3, v2, Ldzs;->b:Lbll;

    invoke-virtual {v3}, Lbll;->b()Lmsz;
    ...
    :cond_2
    iget-object v0, v0, Ldzv;->c:Ljet;

    iget-object v2, v0, Ljet;->b:Lmrj;

    new-instance v3, Ljex;

    invoke-direct {v3, v0, v1}, Ljex;-><init>(Ljet;Landroid/graphics/Bitmap;)V
