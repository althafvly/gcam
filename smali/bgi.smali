...
.method private constructor <init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Lgmk;I)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lbgi;->b:Landroid/graphics/PointF;

    iput-object p2, p0, Lbgi;->c:Landroid/graphics/PointF;

    iput-object p3, p0, Lbgi;->d:Lgmk;
...
.method private final a(Landroid/graphics/PointF;Landroid/graphics/Rect;)Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v1, p0, Lbgi;->d:Lgmk;

    invoke-virtual {v1, p1}, Lgmk;->a(Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-static {p1, v1, v2}, Lbgi;->a(III)I
    ...
    invoke-static {p1, v1, p2}, Lbgi;->a(III)I
...
.method public static a(Landroid/graphics/PointF;Landroid/graphics/PointF;I)Lbgi;
    .locals 4
    ...
    invoke-direct {v1, p2}, Lgmk;-><init>(I)V

    invoke-direct {v0, p0, p1, v1, v2}, Lbgi;-><init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Lgmk;I)V

    return-object v0
.end method

.method public static a(Landroid/graphics/PointF;Landroid/graphics/PointF;II)Lbgi;
    .locals 4
    ...
    invoke-direct {v0, p0, p1, v1, p3}, Lbgi;-><init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Lgmk;I)V
...
.method public final a(Landroid/graphics/Rect;)[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v1, p0, Lbgi;->c:Landroid/graphics/PointF;

    invoke-direct {p0, v1, p1}, Lbgi;->a(Landroid/graphics/PointF;Landroid/graphics/Rect;)Landroid/hardware/camera2/params/MeteringRectangle;
...
.method public final b(Landroid/graphics/Rect;)[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v1, p0, Lbgi;->b:Landroid/graphics/PointF;
