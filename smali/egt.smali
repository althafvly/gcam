...
.method private constructor <init>(ILnaj;)V
    .locals 1
    ...
    iput-object v0, p0, Legt;->b:Ljava/util/Set;
    ...
    iput-wide p1, p0, Legt;->c:J

    const/4 p1, 0x0

    iput-boolean p1, p0, Legt;->d:Z

    return-void
.end method

.method public constructor <init>(ILnaj;B)V
    .locals 0
    ...
    invoke-direct {p0, p1, p2}, Legt;-><init>(ILnaj;)V
...
# virtual methods
.method public final declared-synchronized a(Legu;)V
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Legt;->b:Ljava/util/Set;
...
.method public final declared-synchronized a(JFF)Z
    ...
    iget-object v1, p0, Legt;->b:Ljava/util/Set;
    ...
    invoke-interface {v2, p1, p2, p3, p4}, Legu;->a(JFF)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(J)[F
    ...
    iget-boolean v1, p0, Legt;->d:Z

    if-nez v1, :cond_0

    iget-wide v4, p0, Legt;->c:J
...
.method public final declared-synchronized a(JJ)[F
    ...
    sget-object v11, Legt;->a:Ljava/lang/String;
    ...
    invoke-static {v11}, Lcub;->d(Ljava/lang/String;)V
...
.method public final declared-synchronized b(Legu;)V
    .locals 1
