...
.method static constructor <clinit>()V
    ...
    sput-object v0, Layb;->b:Landroid/graphics/Paint;
    ...
    :goto_0
    sput-object v0, Layb;->a:Ljava/util/concurrent/locks/Lock;
...
.method public static a(Lart;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static {p1}, Layb;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v1

    invoke-interface {p0, p2, p3, v1}, Lart;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p0

    invoke-static {p1, p0}, Layb;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V

    invoke-static {p1, p0, v0}, Layb;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object p1, Layb;->b:Landroid/graphics/Paint;
    ...
    sget-object p0, Layb;->a:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p1, Layb;->a:Ljava/util/concurrent/locks/Lock;
...
.method public static b(Lart;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 2
    ...
    invoke-interface {p0, p3, v0, v1}, Lart;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p0, p3}, Layb;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static c(Lart;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 1
    ...
    :cond_1
    :goto_0
    invoke-static {p0, p1, p2, p3}, Layb;->b(Lart;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
