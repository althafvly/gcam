...
.method public static a(Lmbg;Landroid/os/Parcel;I)V
    .locals 3
    ...
    iget-object v1, p0, Lmbg;->b:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lmbg;->d:Landroid/app/ApplicationErrorReport;
    ...
    iget-object v1, p0, Lmbg;->f:Lcom/google/android/gms/common/data/BitmapTeleporter;
    ...
    iget-object v1, p0, Lmbg;->h:Ljava/util/List;
    ...
    iget-object v1, p0, Lmbg;->j:Lmbo;

    const/16 v2, 0xc

    invoke-static {p1, v2, v1, p2}, Lfzn;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-object v1, p0, Lmbg;->k:Lmbm;

    const/16 v2, 0xd

    invoke-static {p1, v2, v1, p2}, Lfzn;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-boolean v1, p0, Lmbg;->l:Z

    const/16 v2, 0xe

    invoke-static {p1, v2, v1}, Lfzn;->a(Landroid/os/Parcel;IZ)V

    iget-object v1, p0, Lmbg;->m:Landroid/graphics/Bitmap;

    const/16 v2, 0xf

    invoke-static {p1, v2, v1, p2}, Lfzn;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-object p2, p0, Lmbg;->n:Ljava/lang/String;

    const/16 v1, 0x10

    invoke-static {p1, v1, p2}, Lfzn;->a(Landroid/os/Parcel;ILjava/lang/String;)V

    iget-boolean p2, p0, Lmbg;->o:Z

    const/16 v1, 0x11

    invoke-static {p1, v1, p2}, Lfzn;->a(Landroid/os/Parcel;IZ)V

    iget-wide v1, p0, Lmbg;->p:J

    const/16 p0, 0x12

    invoke-static {p1, p0, v1, v2}, Lfzn;->a(Landroid/os/Parcel;IJ)V
...
.method public final synthetic createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    invoke-static {v0, v2, v3}, Lfzo;->a(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    :pswitch_6
    sget-object v3, Lmbm;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :pswitch_7
    sget-object v3, Lmbo;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :pswitch_9
    sget-object v3, Lmbk;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-static {v0, v2, v3}, Lfzo;->c(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Ljava/util/ArrayList;
    ...
    :pswitch_f
    invoke-static {v0, v2}, Lfzo;->j(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    invoke-direct/range {v6 .. v23}, Lmbg;-><init>(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;Landroid/app/ApplicationErrorReport;Ljava/lang/String;Lcom/google/android/gms/common/data/BitmapTeleporter;Ljava/lang/String;Ljava/util/List;ZLmbo;Lmbm;ZLandroid/graphics/Bitmap;Ljava/lang/String;ZJ)V
