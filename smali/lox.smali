...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;Lloz;Lcom/google/android/apps/refocus/processing/ProgressCallback;Landroid/graphics/Bitmap;)V
    .locals 0
    ...
    iput-object p2, p0, Llox;->c:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    iput-object p2, p0, Llox;->f:Landroid/os/Handler;

    iput-object p3, p0, Llox;->a:Lloz;

    iput-object p4, p0, Llox;->d:Lcom/google/android/apps/refocus/processing/ProgressCallback;

    iput-object p5, p0, Llox;->e:Landroid/graphics/Bitmap;
...
.method public final run()V
    ...
    iget-object v1, p0, Llox;->c:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;

    iget-object v2, p0, Llox;->d:Lcom/google/android/apps/refocus/processing/ProgressCallback;

    iget-object v3, p0, Llox;->e:Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Llox;->f:Landroid/os/Handler;

    new-instance v2, Llow;

    invoke-direct {v2, p0, v0}, Llow;-><init>(Llox;Landroid/graphics/Bitmap;)V
